#pragma once
#ifndef __chatserv__Logger__
#define __chatserv__Logger__
...
#else
#define log_trace(fmt, ...)	log_write(Logger::LEVEL_TRACE, "%s(%d): " fmt, __FILE__, __LINE__, ##__VA_ARGS__)
#endif
...
#endif /* defined(__chatserv__Logger__) */
